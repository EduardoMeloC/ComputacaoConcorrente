...
/*
 * Desta vez, estamos iniciando várias threads e fazendo uma passagemde parametro
 * No caso, o parametro é um int, identificador da i-ésima thread criada.
 *
 * Se a proposta do programa era imprimir "Thread principal terminou" após 
 * o fim de todas as threads, então o programa falhou.
 */
